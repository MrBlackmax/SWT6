...
import swt6.spring.worklog.logic.WorklogServiceImpl2;
...
public class LogicTest {
    ...
    private static void testBusinessLogicWithSpringDataRepositories() {
        try (AbstractApplicationContext context = new ClassPathXmlApplicationContext("swt6/spring/worklog/test/applicationContext-jpa2.xml")) {

            var worklog = context.getBean("workLog", WorkLogService.class);
            printTitle("testSaveEmployee", 60, '-');
            testSaveEmployee(worklog);
