...
public class SimpleTimer implements Timer {
    ...
    @Override
    public void start() {
        if (isRunning()) throw new IllegalStateException("Cannot start: Timer is already running");
    ...
    public boolean isRunning() { return tickerThread.get() != null; }

    public int getInterval() { return tickInterval; }
    public void setInterval(int tickInterval) {
        this.tickInterval = tickInterval;
    }

    public int getNoTicks() { return noTicks; }
