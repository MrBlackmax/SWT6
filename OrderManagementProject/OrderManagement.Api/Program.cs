...
using OrderManagement.Api.Util;
...
void ConfigureServices(IServiceCollection services, IConfiguration configuration, IHostEnvironment env)
{
  ...
  services.AddCors(builder =>
    ...
    services.AddDbContext<OrderManagementContext>(options => options.UseSqlServer(connectionString).EnableSensitiveDataLogging());
  ...
  //
  services.AddMediatR(applicationAssemblies).AddTransient(typeof(IPipelineBehavior<,>), typeof(TransactionCommandBehavior<,>));
